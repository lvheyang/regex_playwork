 ...
 * results of a match against a regular expression. The match boundaries, groups and group
 * boundaries can be seen but not modified through a {@code MatchResult}.
 *
