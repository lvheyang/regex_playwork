...
/**
 * This class provides an empty implementation of {@link PCREListener}, which can be extended to
...
public class PCREBaseListener implements PCREListener {
   ...
   */
  @Override
  public void enterQuantifier_type(PCREParser.Quantifier_typeContext ctx) {
  }
   ...
   */
  @Override
  public void exitQuantifier_type(PCREParser.Quantifier_typeContext ctx) {
  }
